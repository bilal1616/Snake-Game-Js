    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmHighscorePanel.innerHTML = "Yüksek Skor: " + (localStorage.jsSnakeHighScore || 0);
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "Windows'ta Tam Ekran modunda oynatmak için F11 tuşuna basın.";
            }
            welcomeTxt.innerHTML = "JavaScript Snake<p></p>Oyunu oynamak için klavyenizdeki <strong>ok tuşlarını</strong> kullanın. " + fullScreenText + "<p></p>";
